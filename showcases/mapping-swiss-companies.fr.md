---
active: true
title: "Mapping Swiss companies: Two analyses based on official registers"
images:
  - image: https://navor.ai/reports/swiss-open-data-card.png
url: https://navor.ai/reports/swiss-open-data
themes:
...
*   **Sources officielles :** croisement de données issues notamment de Zefix, du registre IDE et des données TVA. 
*   **Harmonisation par IA :** normalisation des registres et classification des entreprises à partir de leurs informations disponibles, avec revue des cas ambigus. 
*   **Transparence :** les dates d’extraction et les limites sont documentées. Les classifications sectorielles sont analytiques et ne correspondent pas nécessairement à une classification officielle de l’administration. 

**Cas d’usages** 

*   **Analyse territoriale et sectorielle :** visualiser les concentrations d’entreprises par région et activité. 
*   **Recherche et journalisme :** comparer le tissu économique suisse. 
*   **Aide à la décision :** fournir des données pour les politiques de soutien aux PME. 
*   **Suivi des tendances** : analyser les pôles de croissance selon la région et la date de fondation. 
...
*   **Offizielle Quellen:** Abgleich von Daten, die insbesondere aus Zefix, dem UID-Register und den Mehrwertsteuerdaten stammen.
*   **Harmonisierung mittels KI:** Normalisierung der Register und Klassifizierung der Unternehmen anhand der verfügbaren Informationen, mit Überprüfung mehrdeutiger Fälle.
*   **Transparenz:** Die Datenextraktionsdaten und -grenzen sind dokumentiert. Die Branchenklassifizierungen sind analytischer Natur und entsprechen nicht zwangsläufig einer offiziellen Klassifizierung der Verwaltung.

**Anwendungsfälle**

*   **Territoriale und sektorale Analyse:** Visualisierung der Unternehmenskonzentrationen nach Region und Tätigkeit.
*   **Recherche und Journalismus:** Vergleich der Schweizer Wirtschaftsstruktur.
*   **Entscheidungshilfe:** Bereitstellung von Daten für Massnahmen zur Förderung von KMU.
*   **Trendbeobachtung**: Analyse von Wachstumszentren nach Region und Gründungsdatum.
...
*   **Official sources:** cross-referencing of data from Zefix, the UID registry, and VAT data, among others.
*   **AI-driven harmonization:** standardization of registries and classification of companies based on available information, with review of ambiguous cases.
*   **Transparency:** data extraction dates and boundaries are documented. Sector classifications are analytical and do not necessarily correspond to an official government classification.

**Use Cases**

*   **Geographical and sectoral analysis:** visualize concentrations of companies by region and activity.
*   **Research and journalism:** compare Switzerland’s economic landscape.
*   **Decision support:** provide data to inform SME support policies.
*   **Trend tracking**: analyze growth clusters by region and date of establishment.
